...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void onAuthSuccess(FirebaseUser user, boolean isNewUser) {
    ...
    private boolean validateForm() {
        ...
        if (TextUtils.isEmpty(mEmailField.getText().toString())) {
            ...
            result = false;
        } else if (!android.util.Patterns.EMAIL_ADDRESS.matcher(mEmailField.getText()).matches()) {
            mEmailField.setError("Badly formatted");
            result = false;
        } else {
